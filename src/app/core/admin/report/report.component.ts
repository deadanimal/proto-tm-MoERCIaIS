...
export class ReportComponent implements OnInit, OnDestroy {
  ...
  getChart() {
    let chart = am4core.create("chartdivreport1", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("chartdivreport2", am4charts.XYChart);
  ...
  getChart2() {
    let chart = am4core.create("chartdivreport3", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("chartdivreport4", am4charts.XYChart);
