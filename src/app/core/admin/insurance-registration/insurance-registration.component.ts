...
export class InsuranceRegistrationComponent implements OnInit, OnDestroy {
  ...
  getChartInsuranceRegister1() {
    am4core.useTheme(am4themes_dataviz);
    am4core.useTheme(am4themes_animated);
    // Themes end

    // Create chart instance
    let chart = am4core.create("chartdivinsuranceregistration1", am4charts.PieChart);
  ...
  getChartInsuranceRegister2() {
    am4core.useTheme(am4themes_dataviz);
    am4core.useTheme(am4themes_animated);
    // Themes end

    // Create chart instance
    let chart = am4core.create("chartdivinsuranceregistration2", am4charts.PieChart);

    // Add data
    chart.data = [
      {
        country: "Industrial All Risk",
        litres: 501.9,
      },
      {
        country: "Terrorism",
      ...
      {
        country: "Marine Open Cover",
        litres: 139.9,
      },
      {
        country: "Comprehensive General Liability",
        litres: 128.3,
      },
    ];
