...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  constructor(private zone: NgZone, private modalService: BsModalService, private router: Router,) {}
  ...
  navigatePage(path: String) {
    if (path == "incident") {
      return this.router.navigate(["/admin/incident-management/analysis"]);
    }
    else if (path == "insurance") {
      return this.router.navigate(["/admin/insurance-management/analysis"]);
    } 
    else if (path == "lost") {
      return this.router.navigate(["/admin/lost-control/survey"]);
    } 
    else if (path == "business") {
      return this.router.navigate(["/admin/business-risk"]);
    }
    else if (path == "product") {
      return this.router.navigate(["//admin/product-risk"]);
    } 
    else if (path == "project") {
      return this.router.navigate(["/admin/project-risk"]);
    } 
    else if (path == "compliance") {
      return this.router.navigate(["/admin/compliance"]);
    }
    else if (path == "audit") {
      return this.router.navigate(["/admin/audit/audit-trails"]);
    } 
    else if (path == "report") {
      return this.router.navigate(["//admin/report"]);
    }
  }
}
